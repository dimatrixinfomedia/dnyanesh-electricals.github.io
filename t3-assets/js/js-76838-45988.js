...
/*===============================
/templates/ja_restaurant/js/owl-carousel/owl.carousel.js
================================================================================*/;
...
/*===============================
/templates/ja_restaurant/js/skrollr.js
================================================================================*/;
/*!
 * skrollr core
 *
...
/*===============================
/templates/ja_restaurant/js/script.js
================================================================================*/;
...
$cols.each(function(){maxHeight=Math.max(maxHeight,equalChildHeight?$(this).children().innerHeight():$(this).innerHeight());});if(equalChildHeight){$cols.each(function(){$(this).children().css('min-height',maxHeight);});}else{$cols.css('min-height',maxHeight);}}
$('.equal-height > .col').each(function(){var $col=$(this);$col.data('old-width',$col.width()).data('old-height',$col.innerHeight());});};equalHeight();setInterval(function(){$('.equal-height > .col').each(function(){var $col=$(this);if(($col.data('old-width')&&$col.data('old-width')!=$col.width())||($col.data('old-height')&&$col.data('old-height')!=$col.innerHeight())){equalHeight();return false;}});},500);});$(window).ready(function(){if($('.head-search-wrap').length>0){$('.btn-search').click(function(){$('.head-search').toggleClass('btn-open');$('.head-search-wrap').toggleClass('btn-open');$('.head-right').toggleClass('btn-open');$('.has-search').toggleClass('has-search-open');if($('.head-search-wrap').hasClass('btn-open')){$('#mod-search-searchword').focus();}});}});})(jQuery);(function($){$(window).ready(function(){var iOS=parseFloat((''+(/CPU.*OS ([0-9_]{1,5})|(CPU like).*AppleWebKit.*Mobile/i.exec(navigator.userAgent)||[0,''])[1]).replace('undefined','3_2').replace('_','.').replace('_',''))||false;if(!(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||iOS)){var s=skrollr.init({render:function(data){}});}});})(jQuery);
